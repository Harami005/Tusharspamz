...
HELP_STRING = f"𐏓 ꯭ ⃪ͥ͢ ᷟ𝐓𝐔𝐒𝐇𝐀𝐑 ̶꯭𝅥ͦ𝆬😈𝗦𝗣𝗔𝗠😜 𝗛𝗘𝗟𝗣 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ 🥀: @Vivek_y05**"
...
HELP_BUTTON = [
    ...
    [
      ...
      Button.url("𝐎𝚆𝙽𝙴𝚁 ", "https://t.me/I_AM_PAPA0809")
    ],
    [
      Button.url(" 𝐂ʜᴀɴɴᴇʟ ", "https://t.me/MERI_HAWELI"),
      Button.url("𝐒ᴜᴘᴘᴏʀᴛ ", "https://t.me/TUSHAR_1_SPAMBOT")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/6f2b37194bdb3fc77bbdd.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("ᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ 𐏓 ꯭ ⃪ͥ͢ ᷟ𝐓𝐔𝐒𝐇𝐀𝐑 ̶꯭𝅥ͦ𝆬😈 sᴘᴀᴍ  ʙᴏᴛs !! @I_AM_PAPA0809", cache_time=0, alert=True)
